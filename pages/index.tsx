  ...
  return (
    <div className=''>
      ...
      <main className='max-w-6xl mx-auto p-2'>
        {loadingListings ? (<p className='text-center animate-plus text-blue-500'>Loading listings... </p>
        ) : (
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 mx-auto'>
          {listings?.map((listing) => (
            <Link className='flex flex-col card hover:scale-105 transition-all duration-150 ease-out'
